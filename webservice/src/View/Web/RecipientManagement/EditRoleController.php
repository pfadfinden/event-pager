...
#[Route('/recipients/role/{id}/edit', name: 'web_recipient_management_role_edit')]
    ...
    public function __invoke(Request $request, string $id): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                ...
                $this->addFlash('success', t('Role updated successfully'));

                return $this->redirectToRoute('web_recipient_management_role_details', ['id' => $recipient->id]);
            } catch (RuntimeException $e) {
                $this->addFlash('error', t('Failed to update role: {message}', ['message' => $e->getMessage()]));
            }
        }

        return $this->render('recipient-management/role/edit.html.twig', [
            'form' => $form,
            'recipient' => $recipient,
        ]);
    }
