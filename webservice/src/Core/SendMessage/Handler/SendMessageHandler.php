...
// use App\Core\SendMessage\Event\NewMessageReceived;
...
final readonly class SendMessageHandler
{
    public function __construct(
        ...
        // private readonly object $eventBus,
    ) {
    }
    ...
    public function __invoke(SendMessage $cmd): void
    {
        ...
        // $this->eventBus->dispatch(new NewMessageReceived($incomingMessage->messageId));
    }
}
